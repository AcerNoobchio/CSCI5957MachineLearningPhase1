...
if __name__ == '__main__':
    ...
    directory = 'C:\\Users\\Stephanos\\Documents\\Dev\ML\\CSCI5957MachineLearningPhase1\\rawData\\Cycling'
    ...
    paths = FileReader.ReadFilePaths(directory, '')
    grapher = Graph()
    ...
    for d in data:
        d = pd.DataFrame(d)
        dataFrames.append(d)
    Synchronization.trim_start_end_times(dataFrames)
